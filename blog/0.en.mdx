---
title: Transparent Startup Experiment 2.0 - Help 100 People Turn Ideas into Products
date: '2025-12-01'
---

In 2019, I started a ["**Transparent Startup Experiment**"](https://blog.t9t.io/transparent-startup-experiment-2019-05-20/), challenging myself to create 10 products in one year, with the goal of reaching $1,000 per month in passive income. The entire process was completely transparent: my thought process, the source code of the products, and the revenue - all public. This is also where the website name comes from: **t9t - short for transparent**.

At the end of that year, I hadn't earned any significant passive income, so I declared the [experiment a failure](https://blog.t9t.io/t9t-year1-2020-05-18/). Looking back now, it was a good failure. It brought me many valuable things: I actually built 10 products from scratch - from idea to implementation, to launch, and simple promotion. [These products](https://t9t.io/en#products) have fortunately served millions of users. Additionally, since most of these products were launched globally, they gave me opportunities to be discovered and hired by employers in higher-paying regions around the world. They also led to [collaborations](http://t9t.io/en#partnerships) with people I initially thought were out of reach.
